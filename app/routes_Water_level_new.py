def register_water_level_routes(app):
    ...
    import os
    from Waterlevel_service import forecast_future_waterlevel
    ...
    def Waterlevelpredict():
        if request.method == 'POST':
            ...
            try:
                ...
                prediction_df, plot_html = forecast_future_waterlevel(user_start, user_end)
                ...
                prediction_df.to_csv(
                    "D:/Sooraj/Project_Bromine_Concentration/app/outputs/water_level_prediction_output.csv", index=False)
    ...
    def download_predictions_Water():
        try:
            file_path = "D:/Sooraj/Project_Bromine_Concentration/app/outputs/water_level_prediction_output.csv"
